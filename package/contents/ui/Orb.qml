...
Item {
    ...
    Rectangle {
        anchors.fill: parent
        radius: width / 2
        color: Qt.rgba(0.04, 0.05, 0.10, 0.80)
        border.color: {
            switch (orbRoot.ringClass) {
            case "orb-green":  return Qt.rgba(0.20, 0.82, 0.60, 0.65)
            case "orb-yellow": return Qt.rgba(0.98, 0.75, 0.14, 0.65)
            case "orb-red":    return Qt.rgba(0.97, 0.44, 0.44, 0.75)
    ...
    Text {
        ...
        color: {
            switch (orbRoot.ringClass) {
            case "orb-green":  return "#34d399"
            case "orb-yellow": return "#fbbf24"
            case "orb-red":    return "#f87171"
