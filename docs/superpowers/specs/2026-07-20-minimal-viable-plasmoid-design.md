...
│                                                         │
│  providers: [Provider] → Orb / ProviderGroup 绑定       │
│                                                         │
...
| MiniMax | 余额(88%) | 降级 | 🟡 | 接近红色阈值、extraText |
...
│  └─────────────────────────────────────────────────────────┘ │
│  ┌─ MiniMax ──────────────────────────────────────────────┐ │
│  │ ● 余额  █████████░ 88%  4小时30分钟后  活动期 8月底结束  │ │
│  └─────────────────────────────────────────────────────────┘ │
│  ┌─ Codex ────────────────────────────────────────────────┐ │
│  │ ● 周限额 █████░░░░░ 67%  周日 00:00  503/750 次        │ │
│  └─────────────────────────────────────────────────────────┘ │
│                                                              │
│  ───────────────────────────────────────────── 最后更新: 10秒前│
└─────────────────────────────────────────────────────────────┘
...
│                                                              │
│  ── 月限额 ──────────────────────────────────────────────── │
│  Codex   █████░░░░░ 67%  周日 00:00  503/750 次              │
└─────────────────────────────────────────────────────────────┘
```

**渲染规则：**
- 按供应商分组：每个 provider 一张卡片，内部堆叠 PlanBar
- 按时间窗口分组：按 `plan.windowLabel` 聚合，每个窗口一张卡片，内部列各供应商的 PlanBar
- 窗口标签兼容任意长度（3小时/4小时/5小时/7天/周/月等）
...
│  │                                           [测试运行] ▸    │   │
│  │  ┌── 测试结果预览 ───────────────────────────────────┐  │   │
│  │  │ ✓ 5小时窗口: 88% (12.5/100 USD) 4小时30分钟后重置  │  │   │
